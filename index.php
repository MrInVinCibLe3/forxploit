<html lang=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script>

    var info = {
        site_icon: "https://mrinvincible.xyz/logoinvin.png" ,
        sayfa_baslik: "MR.1NV1NC1BL3",
        baslik: 'Hacked By' + '<span class="red"> ' + 'MR.1NV1NC1BL3' + '</span>',
        mesaj: "Telegram : <a href="https://t.me/+1QGRv9ZvUthhNTY1">CLIQUE</a>.",
        muzik: "https://mrinvincible.xyz/invincible.mp3",
        ozlu_soz: " No System Is Perfecto!!</br>Improve Your Program!!",
        arka_plan: "https://c.tenor.com/AdyODFy5zhAAAAAC/anime-sharingen-madara-eye.gif"
    }
...
<link rel="icon" href="https://mrinvincible.xyz/logoinvin.png" type="image/x-icon" class="site_icon">
...
<style>
        ...
        body{
            ...
            font-size: 1rem;
            user-select: none;
    cursor: url(https://mrinvincible.xyz/sym46.cur), progress !important
        }
        * { margin: 0; padding: 0; }
...
<body cz-shortcut-listen="true" oncontextmenu="return false" onselectstart="return false" ondragstart="return false"><div data-v-32478853="" class="odm_extension image_downloader_wrapper"><!----></div>
...
<div class="resimler">
<img src="https://mrinvincible.xyz/ngxcuer.jpg" alt="Hacked By MR.1NV1NC1BL3" class="resim active">
</div>
<div class="con active">
<div class="area">
<div class="header">
<img src="https://mrinvincible.xyz/anime-sharingen-madara-eye.gif" alt="">
<h1>Hacked By<span class="red"> MR.1NV1NC1BL3</span></h1>
</div>
<div class="main">
<p class="text">Go and fuck up,bitch..</a></p>
</br>
<font style="font-family: 'Lemon', serif; size="2"><b>  |&nbsp;  It's better to have a Good Security NO more, than <font color="red">fooling </font>everyone including your selves & have one&nbsp;  |
        <br>
         <font style="font-family: 'Lemon', serif; size="2" face="Sarpanch" color="white" size"10" class="message">#NONSENSE &bull; It only makes us <font color="red">SLOWER.</font><br>
      |&nbsp;  Don't try to find Us <font color="red">Else </font>You can imagine what we can do!&nbsp; <br>
        ------------------------
    </b></font><b>
	</font>
</div>
...
<audio loop="10" autoplay="1" class="music" style="display: none;" src="https://mrinvincible.xyz/invincible.mp3">
